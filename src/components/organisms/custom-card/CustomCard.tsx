...
export interface CustomCardProps extends StatusProps {
  col: 4;
  title: string;
  logo: ReactNode;
  icon: string;
...
const CustomCard: FC<CustomCardProps> = ({
  ...
  return (
    <div
      ...
      <div
        ref={containerRef}
        className={classNames(styles.CustomCardWrapper, {
          [styles[`CustomCardWrapper--${col}`]]: col
        })}>
        <div className={styles.CardHeader}>
          ...
          <div>
            <OptionsIcon
              className={styles[`CustomCardWrapper--menu_button`]}
              onClick={(e) => {
                e.stopPropagation();
      ...
      <div ref={containerRef} className={styles[`CustomCardWrapper--footer`]}>
        {/* <CustomStatus
