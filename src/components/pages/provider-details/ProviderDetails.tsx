      ...
      <div className={styles['ProviderDetailsBase--container']}>
        <div className={styles['ProviderDetailsBase--leftBlock']}>
          <DetailsMainInfo
            label='Novomatic'
            id='ID1234567'
            src='https://media-exp1.licdn.com/dms/image/C4D0BAQFugPwCvxLIvw/company-logo_200_200/0/1622528934908?e=2159024400&v=beta&t=83LWesSyQcZgmCwUKNF-FSrA7lZc_070S6RDrS6RZXQ'
          />
          <CountView />
