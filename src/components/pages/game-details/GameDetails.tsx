...
import { Breadcrumb, Card, IconButton, SubTab, SubTabProps, Tab } from '@my-ui/core';
...
const GameDetails: FC<GameDetailsProps> = ({ userInfo, walletInfo, statusInfo, lastActivity, breadCrumb, tabs }) => {
      ...
      <div className={classNames(styles['GameDetailsBase--content'])}>
        ...
        <Card className={classNames(styles['GameDetailsBase--content-control'])} borderRadius={1.6}>
          <div className={classNames(styles['GameDetailsBase--content-control__tabs'])}>
            ...
            />
            <div className={classNames(styles['GameDetailsBase--content-control__sub-tabs'])}>
              {tabValue === 1 && (
                <SubTab
                  options={[
