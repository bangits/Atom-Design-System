...
export declare type FilterType = 'select' | 'checkbox' | 'radio' | 'input' | 'dropdown' | 'from-to' | 'datepicker';
...
export declare type FilterProp = {
    name: string;
    label: string;
} & ({
    type: 'input';
    ...
    type: 'custom';
    component: (props: {
        onChange: (name: string, value: FilterValueType) => void;
    }) => JSX.Element;
});
